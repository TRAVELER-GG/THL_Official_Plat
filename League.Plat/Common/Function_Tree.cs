...
namespace League.Plat
{
    ...
    {
        public static List<Top_Menu> Get_Top_Menu_List(User_Plat U, string MOD_Name, string Left_Menu_Name)
        {
        ...
        public static Function_Tree Get_Tree_List(User_Plat U)
        {
            ...
            foreach (var x in Item.MOD_List)
            {
                foreach (var xx in x.Left_Menu_List)
                {
                    ...
                    {
                        xxx.Active = U.Roles_Title_List.Intersect(xxx.Role_Titel_List).Count() > 0 ? 1 : 0;
                        xxx.Active = U.Roles_Title.Contains("Admin") ? 1 : xxx.Active;
                    }
                ...
                x.Left_Menu_List = x.Left_Menu_List.Where(c => c.Active == 1).ToList();
